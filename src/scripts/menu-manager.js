...
function MobileMenu() {
  ...
  {
    $('.language').addClass('block').transition({ scale: 1.0, opacity: 1 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)');
    ...
    $('.main-menu').addClass('block').transition({ opacity: 1 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)')
    $('div.menu').removeClass('none').addClass('table').transition({ opacity: 1 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)')

    if (ruen_status) {
      $('.sub-menu.en').removeClass('none').transition({ scale: 1.0, opacity: 1 }, 1200, 'cubic-bezier(0.19, 1, 0.22, 1)')
    }

    else {
      $('.sub-menu.ru').removeClass('none').transition({ scale: 1.0, opacity: 1 }, 1200, 'cubic-bezier(0.19, 1, 0.22, 1)')
    }

    $('ul.mobile').addClass('open').transition({ scale: 1, opacity: 1 }, 1200, 'cubic-bezier(0.075, 0.82, 0.165, 1)') // АКТИВИРОВАТЬ ПУНКТЫ МЕНЮ В ul, li
  ...
  else // ЗАКРЫТЬ МЕНЮ
  {
    ...
    $('ul.mobile').transition({ scale: 0.9, opacity: 0 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)') // УБИРАЕМ ПУНКТЫ МЕНЮ
    $('.projects-menu').transition({ opacity: 0 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)') // УБИРАЕМ ПУНКТЫ МЕНЮ
    $('.mobile-projects.ru').transition({ scale: 1.1, opacity: 0 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)') // УБИРАЕМ ПУНКТЫ МЕНЮ
    $('.mobile-projects.en').transition({ scale: 1.1, opacity: 0 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)') // УБИРАЕМ ПУНКТЫ МЕНЮ
    $('.main-menu').transition({ opacity: 0 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)') // УБИРАЕМ ПУНКТЫ МЕНЮ
    $('div.menu').transition({ opacity: 0 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)')
    ...
    $('.language').transition({ scale: 0.9, opacity: 0 }, 1200, 'cubic-bezier(0.175, 0.885, 0.32, 1.275)');

    setTimeout(close, 1200) // ПАУЗА, ПОКА ВСЁ НЕ СВЕРНЁТСЯ ДО КОНЦА
    function close() {
