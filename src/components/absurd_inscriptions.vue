 ...
 module.exports = {
    ...
    methods: {  
      ...
      getAllPosts: function() {//Метод получения ВСЕХ данных из json-файла
        ...
        this.$http.get(this.absurd_inscriptionsJSON).then(function(response) {
          this.absurd_inscriptionsArray = response.data}, function(error){})
      },
