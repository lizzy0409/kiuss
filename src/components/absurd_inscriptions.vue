<template>
  <div class="container">
    <div class="sub-container">
      ...
      <pre class="annotation_ru none" style="text-align: left; opacity:0;">Серия уличных надписей, которые абсурдны не столько в силу своего аллогичного сюжета (что интересно как минимум с семиотической точки зрения, как метод <a href="https://instructions.stranno.su/#Bookmark6" target="_blank">денатурализации</a>), сколько потому, что находятся в контексте улицы и представлены прохожим, не готовым к таким сообщениям, в результате чего и возникает <a href="https://instructions.stranno.su/#Bookmark15" target="_blank">момент обнаружения</a>. Также смотрите проект с <a href="https://stranno.su/#/strange_posters">постерами</a>.
      <br>«Абсурдные фразы»<br>Тушь, 2013
      </pre>
      <pre class="annotation_en" style="text-align: left;">A series of street inscriptions that are absurd not so much because of their allogical plot (which is interesting at least from a semiotic point of view, as a method of <a  href="https://instructions.stranno.su/#Bookmark6" target="_blank">denaturalization</a>), but because they are in the context of the street and are presented by passersby who are not ready for such messages, and as a result of which there is the <a href="https://instructions.stranno.su/#Bookmark15" target="_blank">moment of detection</a>. Also see the project with <a href="https://stranno.su/#/strange_posters">posters</a>.
