<template>
  <header
    v-bind:class="{ 'header--disactive': isDisactive, 'header--open': isOpen }"
    class="header"
  >
    <div v-if="this.$store.state.languageMarker" class="header__container">
      <div class="menu" v-on:click="hidePhoto" v-bind:class="{ 'menu--open': show }">
        <div class="header__left">
          <span v-on:click="blur">projects</span>
          <router-link v-on:click.native="allOff" to="/about">about</router-link>
        </div>
        <div class="header__right">
          <button class="language" v-on:click="ruen" type="button">
            <p>ru / en</p>
          </button>
        </div>
      </div>
      ...
      <transition name="slide-fade">
        <div class="projects" v-if="show">
          <router-link
            v-on:mouseover.native="showPhoto"
            v-on:mouseout.native="hidePhoto"
    ...
    <div v-else class="header__container">
      <div class="menu" v-on:click="hidePhoto" v-bind:class="{ 'menu--open': show }">
        <div class="header__left">
          <span v-on:click="blur">проекты</span>
          <router-link v-on:click.native="allOff" to="/about">о кюсе</router-link>
        </div>
        <div class="header__right">
          <button class="language" v-on:click="ruen" type="button">
            <p>ru / en</p>
      ...
      <transition name="slide-fade">
        <div class="projects" v-on:click="hidePhoto" v-if="show">
          <router-link
            v-on:mouseover.native="showPhoto"
            v-on:mouseout.native="hidePhoto"
            data-img="/images/projects/threads/3.1.jpg"
          ...
          <router-link
            ...
            data-img="/images/projects/simulation_welfare/1.jpg"
            to="/simulation_of_welfare"
            >Симуляция благополучия</router-link
          ><br />
          <router-link
            v-on:mouseover.native="showPhoto"
            v-on:mouseout.native="hidePhoto"
          ...
          <router-link
            ...
            data-img="/images/projects/migrant_workers_under_protection/1.jpg"
            to="/gastarbeiters_under_protection"
            >Гастарбайтеры под защитой</router-link
          ><br />
          <router-link
            v-on:mouseover.native="showPhoto"
            v-on:mouseout.native="hidePhoto"
          ...
          <router-link
            ...
            data-img="/images/projects/when_the_traffic_lights_are_off/logo.png"
            to="/when_the_traffic_lights_are_off"
            >Когда не работают светофоры</router-link
          ><br />
          <router-link
            v-on:mouseover.native="showPhoto"
            v-on:mouseout.native="hidePhoto"
          ...
          <router-link
            ...
            data-img="/images/photography/casual_passerby/14.jpg"
            to="/casual_passerby"
            >Случайные прохожие</router-link
          ><br />
          <router-link
            v-on:mouseover.native="showPhoto"
            v-on:mouseout.native="hidePhoto"
